<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            <h3 class="h-front fw-bold fs-3 mb-2"><?php echo $settings_r['site_title']?></h3>
            <p>
...
<h6 class="text-center bg-dark text-white p-3 m-0"> Designed and Developed by KP Dev</h6>

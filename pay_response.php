<?php
    ...
    if($isValidChecksum == "TRUE") 
    {
        ...
        {
            $upd_query="UPDATE `booking_order` SET `booking_status`='paymnet failed',`trans_id`='$_POST[TXNID]',`trans_amt`='$_POST[TXNAMOUNT]',`trans_status`='$_POST[STATUS]',`trans_resp_msg`='$_POST[RESPMSG]' WHERE `booking_id`='$slct_fetch[booking_id]'";
